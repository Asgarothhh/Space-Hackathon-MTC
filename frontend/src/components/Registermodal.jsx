...
const PASSWORD_RULES = [
  ...
  { label: '1 строчная латинская буква', test: (p) => /[a-z]/.test(p) },
  { label: '1 спец. символ (!@#$%^)',    test: (p) => /[!@#$%^&*]/.test(p) },
  { label: '1 цифра',                    test: (p) => /\d/.test(p) },
  { label: '1 заглавная латинская буква', test: (p) => /[A-Z]/.test(p) },
];

const InputField = ({ label, placeholder, type = 'text', value, onChange, suffix }) => (
  <div className="flex flex-col gap-1.5">
    ...
    >
      <input
        ...
        value={value}
        onChange={onChange}
        className="flex-1 bg-transparent text-white text-sm px-4 py-3 outline-none placeholder:text-neutral-600"
      />
          ...
          >
            ...
            <div className="flex min-h-[460px]">
              ...
              >
                <div >
                  ...
                  <button
                    ...
                    className="px-15.5 py-1.5 rounded-full text-white text-xs font-medium transition-colors"
                    style={{
              ...
              <div className="flex-1 p-8 flex flex-col">
                ...
                >
                  <motion.button
                    className="px-8 py-2.5 rounded-xl text-white text-sm font-semibold tracking-wide"
                    style={{
                      background: 'linear-gradient(90deg, #3d1f6e 0%, #251045 100%)',
